...
export const StyledFirstSide = styled.div`
    ${tw`flex items-center justify-center w-full rounded-l-lg`}
    & {
...
export const StyledFormContainer = styled.div`
    ${tw`flex w-full mobile:rounded-lg rounded-r-lg max-w-3xl h-[fit-content] flex-col justify-center items-center dark:bg-smokeWhite bg-black p-8 mobile:p-3 `}
`;
...
export const StyledLabel = styled.label`
    ${tw`text-white dark:text-black text-sm font-semibold`}
`;
